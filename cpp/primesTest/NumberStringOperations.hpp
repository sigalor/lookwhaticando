...
namespace NumberStringOperations
{
	...
	long stolCustom(std::string num, int base, std::string baseAlphabet)											//string to long
	{
		long ret = 0;
